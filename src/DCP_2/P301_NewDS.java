 ...
 * Triplebyte
 *
 * @author SHUBHAM Implement a data structure which carries out the following
 * operations without resizing the underlying array: •	add(value): Add a value
 * to the set of values. •	check(value): Check whether a value is in the set.
